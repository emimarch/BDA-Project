...
We therefore conclude that with our current parametrizations for the pooled and the hierarchical model, the hierarchical model appears to be the best performing model. 
